...
@section('title', 'mise à jour utilisateur')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Mise à jour {{ session()->get('user_role') == 'SuperAdmin' ? 'Utilisateur' : 'Client' }}</h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Mise à jour') }}</div>
